...
const CARDS = [
  {
    ...
    description: "가까운 사람이 예상치 못한 시련을 줄 수 있습니다. 그러나 지금의 위기를 두려워하기보다 직시하세요. 탑이 허물어진 자리에서야 비로소 진짜 기초를 새로 쌓을 수 있습니다."
  },
  {
    id: "the-hermit",
    name: "THE HERMIT 은둔자",
    ...
    description: "잠시 멈추고 혼자가 되어보세요. 지금 당신에게 필요한 답은 밖이 아닌 내면에 있습니다. 고요함 속에서 지혜를 찾으세요."
  },
  {
    id: "justice",
    name: "JUSTICE 정의",
    ...
    description: "감정적으로 대처하면 오히려 일을 그르칠 수 있습니다. 냉철한 판단으로 공정하고 정의로운 선택을 할 때 입니다."
  },
  {
    id: "the-emperor",
    name: "THE EMPEROR 황제",
    ...
    description: "때로는 당당하게 주도권을 쥘 필요가 있습니다. 스스로의 원칙과 기준을 따르세요."
  },
  {
    id: "the-hierophant",
  ...
  },
  {
    ...
    description: "지금 겪는 고난은 새로운 한 걸음의 토대가 되는 과정입니다. 그 끝에서는 놀라운 세계를 마주할 수 있을 거예요."
  },
  {
    id: "the-chariot",
    name: "THE CHARIOT 전차",
  ...
  },
  {
    ...
    description: "본인의 기준은 본인이 세우는 것입니다. 자신에게 맞는 속도와 기준을 다시 설정해보세요."
  },
  {
    id: "strength",
    name: "STRENGTH 힘",
  ...
  },
  {
    ...
    description: "가끔은 너무 많이 아는 것이 근심을 키워 용기를 내지 못하게 할 때가 있습니다. 오늘은 걱정보다 일단 그냥 뛰어드는 것이 정답일 수 있어요."
  },
  {
    id: "special-card",
    name: "???????",
